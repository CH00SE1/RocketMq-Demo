        ...
        FastAutoGenerator.create(url, username, password)
                .globalConfig(builder -> {
                    builder.author("CHOOSE1") // 设置作者
                            ...
                            // 指定输出目录
                            .outputDir(System.getProperty("user.dir") + "/rocketmq-comsumer/src/main/java"); // 指定输出目录
                })
                .packageConfig(builder -> builder.parent("com.consumer.table"))
